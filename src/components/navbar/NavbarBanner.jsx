    ...
    return (
        <div className='py-4 md:flex md:items-center md:justify-between md:h-18'>
            <div className='w-full md:w-auto flex justify-between gap-3'>
                <div className='flex gap-2 justify-center w-full md:w-auto items-center bg-[#ffe51fff] h-11 py-5 px-6 border border-[#ffffff66] rounded-xl'>
                ...
                <div className='flex gap-1 justify-center w-full md:w-auto items-center bg-[#f0f0f0] h-11 py-5 px-6 border border-[#f0f0f0] rounded-xl'>
